INSERT INTO catalog_returns  SELECT * FROM crv ON CONFLICT (cr_item_sk, cr_order_number) DO UPDATE SET
...
INSERT INTO catalog_sales   SELECT * FROM csv ON CONFLICT (cs_item_sk, cs_order_number) DO UPDATE SET
...
INSERT INTO inventory       SELECT * FROM iv ON CONFLICT (inv_date_sk, inv_item_sk, inv_warehouse_sk) DO UPDATE SET
    inv_quantity_on_hand      = excluded.inv_quantity_on_hand
;



INSERT INTO store_returns   SELECT * FROM srv ON CONFLICT (sr_item_sk, sr_ticket_number) DO UPDATE SET
...
INSERT INTO store_sales     SELECT * FROM ssv ON CONFLICT (ss_item_sk, ss_ticket_number) DO UPDATE SET
...
INSERT INTO web_returns     SELECT * FROM wrv ON CONFLICT (wr_item_sk, wr_order_number) DO UPDATE SET
...
INSERT INTO web_sales       SELECT * FROM wsv ON CONFLICT (ws_item_sk, ws_order_number) DO UPDATE SET
